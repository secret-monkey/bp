...
<div class="fieldcontain ${hasErrors(bean: BPFeedbackInstance, field: 'buyer', 'error')} required">
	...
	<g:select id="buyer" name="buyer.id" from="${bp.User.list()}" optionKey="id" required="" value="${BPFeedbackInstance?.buyer?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: BPFeedbackInstance, field: 'seller', 'error')} required">
	...
	<g:select id="seller" name="seller.id" from="${bp.User.list()}" optionKey="id" required="" value="${BPFeedbackInstance?.seller?.id}" class="many-to-one"/>
</div>
